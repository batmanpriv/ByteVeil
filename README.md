...
* Additional format-specific embedding strategies
...
3. Make your changes.
4. Keep the implementation focused.
5. Build the project.
...
When modifying format-specific embedding logic, consider:
...
ByteVeil is intended for legitimate use cases such as:
...
* Controlled data-hiding experiments
* Personal data protection
* Learning about steganography and file containers

Use ByteVeil only on files and systems you own or are authorized to modify.
...
If you discover a potential security vulnerability, please avoid publicly disclosing sensitive details before the issue has been reviewed.

You can contact the maintainer through GitHub:
...
* Relevant sample files if safe to share
* A possible mitigation if known

Do not include passwords, API keys, tokens, private files, or other sensitive information in public issues.

---

# License

See [`LICENSE`](LICENSE) for the license under which ByteVeil is distributed.

If this repository does not yet contain a `LICENSE` file, add one before publishing the project as open source.
...
* Repository: https://github.com/batmanpriv/ByteVeil
...
<p align="center">
  ...
  <br>
  <sub>Hide the data. Keep the file.</sub>
</p>
